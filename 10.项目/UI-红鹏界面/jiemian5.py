...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_4.addWidget(self.show_image)
        ...
        self.coordinate_data_3 = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.coordinate_data_3.sizePolicy().hasHeightForWidth())
        self.coordinate_data_3.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.coordinate_data_3.setFont(font)
        self.coordinate_data_3.setAlignment(QtCore.Qt.AlignCenter)
        self.coordinate_data_3.setObjectName("coordinate_data_3")
        self.horizontalLayout_3.addWidget(self.coordinate_data_3, 0, QtCore.Qt.AlignLeft)
        ...
        self.verticalLayout.addWidget(self.setting_show)
        self.horizontalLayout_5.addLayout(self.verticalLayout)
        self.verticalLayout_2 = QtWidgets.QVBoxLayout()
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.coordinate_data_4 = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.coordinate_data_4.sizePolicy().hasHeightForWidth())
        self.coordinate_data_4.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.coordinate_data_4.setFont(font)
        self.coordinate_data_4.setAlignment(QtCore.Qt.AlignCenter)
        self.coordinate_data_4.setObjectName("coordinate_data_4")
        self.horizontalLayout_4.addWidget(self.coordinate_data_4, 0, QtCore.Qt.AlignLeft)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.coordinate_data_3.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:400;\">图片参数信息</span></p></body></html>"))
        self.coordinate_data_4.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:400;\">目标分类</span></p></body></html>"))
